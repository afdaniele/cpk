...
#   timestamp: 2024-01-04T05:03:41+00:00
...
class EnvFile(BaseModel):
    __root__: Union[str, List[Union[str, EnvFile1]]]
...
class ServiceConfigOrSecret(BaseModel):
    __root__: List[Union[str, ServiceConfigOrSecret1]]
...
class Ulimits(BaseModel):
    __root__: Dict[constr(regex=r'^[a-z]+$'), Union[int, Ulimits1]]
...
class Service(BaseModel):
    ...
    networks: Optional[
        Union[
            ListOfStrings, Dict[constr(regex=r'^[a-zA-Z0-9._-]+$'), Optional[Networks]]
        ]
    ] = None
    ...
    ports: Optional[List[Union[float, str, Ports]]] = Field(None, unique_items=True)
    privileged: Optional[bool] = None
    ...
    volumes: Optional[List[Union[str, Volumes]]] = Field(None, unique_items=True)
